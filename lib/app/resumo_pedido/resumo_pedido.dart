...
import 'package:loja_emporio_alfa/app/pdf/pdf_view.dart';
import 'package:loja_emporio_alfa/app/providers/itens_pedido_list.dart';
import 'package:loja_emporio_alfa/app/widgets/cardResumo.dart';
import 'package:loja_emporio_alfa/app/widgets/colors.dart';
import 'package:loja_emporio_alfa/database/database.dart';
                      ...
                      pdfLib.Container(
                          ...
                          child: pdfLib.Column(
                              ...
                              children: [
                                ...
                                pdfLib.Text(
                                  'Número do WhatsApp: (64)98408-6019',
                                  style: pdfLib.TextStyle(
                                        ...
                                        child: Container(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () async {
                                              ...
                                              try {
                                                await launch(
                                                    'https://api.whatsapp.com/send?phone=5564984086019');
                                              } catch (error) {
                                                print(error);
                                              }
                                            },
